...
@interface CharacterTests ()

// 1
@property (strong, nonatomic) NSDictionary *characterDetailJson;
@property (strong, nonatomic) Character *testGuy;
